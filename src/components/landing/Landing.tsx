        ...
        <Grid item xs={6}>
          <Paper>
            <div style={{ position: 'relative' }}>
              ...
              >
                <Typography
                  sx={{ textAlign: 'center', fontSize: '2em', color: 'white' }}
                >
                  Geoff Arroyo
                </Typography>
                <Typography
            ...
            <div style={{ height: '20vh', display: 'flex' }}>
              ...
              >
                ...
                <Typography
                  sx={{ fontSize: '.8em', color: 'black', textAlign: 'center' }}
                >
            ...
            >
              ...
              >
                <IconButton color='inherit'>
                  <a
                    href='https://github.com/GeoffA12'
                    target='_blank'
                    rel='noopener noreferrer'
                  >
                    <GithubIcon
                      sx={{ height: '5vh', minWidth: '5vw', mb: 1 }}
                    />
                  </a>
                </IconButton>
              </div>
              ...
              >
                <IconButton color='inherit'>
                  <a
                    href='https://www.linkedin.com/in/geoff-arroyo-4159ab1b1/'
                    target='_blank'
                    rel='noopener noreferrer'
                  >
                    <LinkedInIcon
              ...
              >
                <IconButton color='inherit'>
                  <a
                    href='https://www.facebook.com/geoff.arroyo'
                    target='_blank'
                    rel='noopener noreferrer'
                  >
                    <FacebookIcon
